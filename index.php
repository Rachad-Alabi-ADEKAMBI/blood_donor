...
function blood_donor_enqueue_assets() {
    ...
    wp_enqueue_style('blood-donor-css', $plugin_url . 'public/css/main.css', array(), '1.0.0', 'all');
    wp_enqueue_script('blood-donor-js', $plugin_url . 'public/js/script.js', array(), '1.0.0', true);
